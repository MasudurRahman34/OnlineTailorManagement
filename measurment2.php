...
if ($_SERVER['REQUEST_METHOD']=='POST') {
        ...
        $dsleeve= mysqli_real_escape_string($db->link,$_POST['dsleeve']);
        ...
        if ($pocket=="Select Pocket" || $dsleeve=="Select Sleeve" || $front=="Front" || $back=="Back Pleats" || $bottom=="Bottom" || $cuffs=="Select Cuffs" || $collar=="Collar" || $neck=="" || $chest=="" || $waist=="" || $hip=="" || $length=="" || $soulder=="" || $sleeve=="" || $fitness=="")
            {
                        ...
                        if (!$insertcust) {
                            ...
                            $insertmesurment= "INSERT INTO shirt_measurment(customer_email, neck, chest, waist, hip, length, sleeve, fitness) VALUES('$customer_email', '$neck', '$chest', '$waist', '$hip', '$length', '$sleeve', '$fitness')";
                                ...
                                echo "<script>alert('measurment data not inserted');</script>"; exit();
                                    ...
                                    $insertdesign= "INSERT INTO shirt_design(design_id, customer_email, product_id, pocket, dsleeve, front, back_pleats, bottom, collar, cuffs, other, ddate) VALUES('$design_id', '$customer_email', '$product_id', '$pocket', '$dsleeve', '$front', '$back', '$bottom', '$collar', '$cuffs', '$other_list','$cur_date')";
   ...
   <form action="" method="post" enctype="multipart/form-data">
        ...
        <select class="my-select" name="pocket">
            <option  selected="selected" style="color: red;font-size: 20px">Select Pocket</option>
             ...
             <option data-img-src="admin/imageselect/diamondstraing.jpg" value="Diamond Straight">Diamond Straight</option>
             <option data-img-src="admin/imageselect/classicsquarp.jpg" value="Classic Squar">classic Squar</option>
        ...
        <select class="my-select" name="dsleeve">
                ...
                <div class="block">
                    ...
                    $size= session::get("size"); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" value="<?php echo $customer_name;?>" class="small" readonly/>
                            </td> 
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="email" value="<?php echo $customer_email;?>" class="small" readonly/>
                            </td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <input type="text" value="<?php echo $phone;?>" class="small" readonly/>
                            </td>
                        </tr>
                         ...
                         <tr>
                          ...
                          <tr>
                            ...
                            <td>
                                <input type="text" value="<?php echo $postal_code;?>" class="small" readonly/>
                            </td>
                        </tr>
